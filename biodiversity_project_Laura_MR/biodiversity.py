...
ax=plt.subplot()
plt.bar(range(len(protection_counts)),protection_counts.scientific_name, color="darkslategrey")
...
ax=plt.subplot()
plt.bar(range(len(obs_by_park)),obs_by_park.observations,color="peru")
...
yellowstone_park_weeks=870/507.0
yellowstone_park_weeks
